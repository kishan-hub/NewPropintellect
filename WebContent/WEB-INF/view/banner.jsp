                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0">Add New Banner</h4>
                                    <a href="addbanner" type="button" class="btn btn-primary waves-effect w-md waves-light m-b-5">Add New</a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <h4 class="m-t-0 header-title"><b>Home Page Banner</b></h4>
