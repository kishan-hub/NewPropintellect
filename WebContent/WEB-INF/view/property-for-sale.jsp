                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0">Property for Sale</h4>
                                    <a href="addpropertyforsale" type="button" class="btn btn-primary waves-effect w-md waves-light m-b-5">Add New</a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <h4 class="m-t-0 header-title"><b>Property for Sale List</b></h4>
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tr>
											...
											<td>www.dfdhf.com</td>
                                            <td class="actions">
												<a href="edit-property-for-sale.html" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
                                       ...
                                       <tr>
											...
											<td>www.dfdhf.com</td>
                                            <td class="actions">
												<a href="edit-featured-property.html" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
												<a href="#" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
											</td>
                                        </tr>
										<tr>
