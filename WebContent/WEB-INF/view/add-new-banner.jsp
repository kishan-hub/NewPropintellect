                        ...
                        <ul>
							...
							<li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="banner.jsp"> Banner Images</a></li>
                                    <li><a href="featured-property.html"> Featured Property</a></li>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Add Banner Description</b></h4>
                        			<div class="row">
                        				<div class="col-md-6">
                        					<form class="form-horizontal">
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-9">
	                                                    <input type="text" class="form-control" placeholder="Eg: Bath:1">
	                                                </div>
	                                            </div>
												<div class="form-group">
