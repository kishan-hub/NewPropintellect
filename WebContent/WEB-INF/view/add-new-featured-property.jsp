                        ...
                        <ul>
							...
							<li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="featured-location.html"> Featured Locations</a></li>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Add New Featured Property</b></h4>
                        			<div class="row">
                        				<div class="col-md-6">
                        					<form class="form-horizontal">
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-9">
	                                                    <input type="file" class="form-control" value="Browse File">
	                                                </div>
	                                            </div>
	                                            <div class="form-group">
	                                                <label class="col-md-3 control-label">Caption Name 1</label>
	                                                <div class="col-md-9">
	                                                    <input type="text" class="form-control" placeholder="Eg: Divya sree Republic of Whitefield">
	                                                </div>
	                                            </div>
												<div class="form-group">
	                                                <label class="col-md-3 control-label">Caption Name 2</label>
	                                                <div class="col-md-9">
	                                                    <input type="text" class="form-control" placeholder="Eg: Divya Sree Republic of Whitefield in Brookefield, Bangalore is..">
	                                                </div>
	                                            </div>
												<div class="form-group">
	                                                <label class="col-md-3 control-label">Caption Name 3</label>
	                                                <div class="col-md-9">
	                                                    <input type="text" class="form-control" placeholder="Eg: Bed:1">
	                                                </div>
	                                            </div> 
												<div class="form-group">
	                                                <label class="col-md-3 control-label">Type of Property</label>
	                                                <div class="col-md-9">
	                                                    <input type="text" class="form-control" placeholder="Eg: Apartment, Villa ">
	                                                </div>
	                                            </div>
												<div class="form-group">
	                                                <label class="col-md-3 control-label">Status</label>
	                                                <div class="col-md-9">
	                                                    <input type="checkbox" name="type" value="Featured"> Featured<br>
	                                                    <input type="checkbox" name="type" value="Sale"> Sale<br>
	                                                    <input type="checkbox" name="type" value="Resale"> Resale<br>
	                                                    <input type="checkbox" name="type" value="Ready to move"> Ready to move<br>
	                                                    <input type="checkbox" name="type" value="Under Construction"> Under Construction<br>
	                                                    <input type="checkbox" name="type" value="Completed"> Completed<br>
	                                                    <input type="checkbox" name="type" value="Trending"> Trending<br>
	                                                </div>
	                                            </div> 
												<div class="form-group">
	                                                <label class="col-md-3 control-label">Price</label>
	                                                <div class="col-md-9">
	                                                    <input type="text" class="form-control" placeholder="Eg: 30,00,000 ">
	                                                </div>
	                                            </div>
												<div class="form-group">
	                                                <label class="col-md-3 control-label">Sq ft</label>
	                                                <div class="col-md-9">
	                                                    <input type="text" class="form-control" placeholder="Eg: 30000/- ">
	                                                </div>
	                                            </div>
												<div class="form-group">
	                                                <label class="col-md-3 control-label">Details Link</label>
	                                                <div class="col-md-9">
	                                                    <input type="text" class="form-control" placeholder="Eg: https://propintellect.com/property/durga-projects-and-infrastructure-petals/ ">
	                                                </div>
	                                            </div>
												<div class="form-group">
	                                                <label class="col-md-3 control-label"> </label>
	                                                <div class="col-md-9">
														<button type="button" class="btn btn-primary waves-effect w-md waves-light m-b-5">Submit</button>
	                                                </div>
	                                            </div>
